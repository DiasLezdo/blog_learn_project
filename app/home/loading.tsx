    ...
    <div className="dark:text-cyan-500 mt-2 flex flex-row flex-wrap justify-evenly">
      {arr.map((e) => (
        <div
          key={e}
          role="status"
          className="max-w-sm m-4 border border-gray-200 rounded-sm shadow-sm animate-pulse md:p-6 dark:border-gray-700"
        >
          ...
          <div className="flex items-center mt-4">
            <div className="h-10 bg-gray-200  dark:bg-gray-700 w-32 mb-2"></div>
            <div className="ml-2">
