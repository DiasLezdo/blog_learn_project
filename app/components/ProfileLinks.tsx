...
const ProfileLinks = ({ facebook, twitter, linkedin }: Links) => {
  return (
    <div className="flex mt-4 justify-center">
      {twitter && (
        <a href={twitter} className="w-6 mx-1">
          <svg
      ...
      {facebook && (
        <a href={facebook} className="w-6 mx-1">
          <svg
            className="fill-current cursor-pointer text-gray-500 hover:text-black dark:hover:text-cyan-500"
            width="100%"
            height="100%"
      ...
      {linkedin && (
        <a href={linkedin} className="w-6 mx-1">
          <svg
            className="fill-current cursor-pointer text-gray-500 hover:text-black dark:hover:text-cyan-500"
            width="100%"
            height="100%"
