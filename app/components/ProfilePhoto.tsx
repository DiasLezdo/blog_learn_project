...
const ProfilePhoto = ({ avatar, firstName }: Props) => {
  ...
  function handleChange(e: ChangeEvent<HTMLInputElement>) {
    ...
    if (file) {
      setPhoto(file); // Set the file as photo
      setFile(URL.createObjectURL(file)); // Create a URL for the file and set it as file
    }
  }
  ...
  const handleSubmit = async (e: MouseEvent<HTMLElement>) => {
    e.preventDefault();
    if (!photo) {
      // Handle the case where photo is undefined (e.g., show an error)
          ...
          >
            ...
            <div className="p-4 space-y-4 text-start h-80 overflow-y-auto">
              {file ? (
                ...
                <div className="w-full py-9 bg-gray-50 dark:bg-gray-600 rounded-2xl border border-gray-300 gap-3 grid border-dashed">
                  ...
                  <div className="grid gap-2">
                    <h4 className="text-center text-gray-900 text-sm dark:text-white font-medium leading-snug">
